        ...
        <div className="relative z-10 w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex items-center">
          <div className="max-w-xl bg-white/90 backdrop-blur-md p-10 md:p-12 border border-gray-100 md:translate-y-8 rounded-sm">
            ...
            <p className="text-gray-500 mb-8 max-w-md text-sm leading-relaxed">
              Discover curated furniture pieces that elevate your space with uncompromising quality and refined aesthetics.
            </p>
            <Link 
              to="/products"
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-16 lg:gap-24 items-center">
            ...
            <div className="order-1 md:order-2">
              ...
              <p className="text-gray-500 mb-6 text-sm leading-relaxed">
                At SB Enterprise, we believe that furniture should be more than just functional. It should be a statement of art, carefully crafted to withstand the test of time.
              </p>
              <p className="text-gray-500 mb-8 text-sm leading-relaxed">
                We source only the finest materials, working with skilled artisans who pour their passion into every piece. The result is furniture that brings warmth, character, and enduring style to your home.
              </p>
